...
export class SourCParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"type_specifier", "translation_unit", "external_declaration", "declaration", 
		"init_declarator", "declarator", "initializer", "initializer_list", "assignment_expression", 
		"conditional_expression", "logical_or_expression", "logical_and_expression", 
		"equality_expression", "relational_expression", "additive_expression", 
		"multiplicative_expression", "cast_expression", "unary_expression", "unary_operator", 
		"type_name", "sizeof_operands", "postfix_expression", "primary_expression", 
		"expression", "constant_expression", "function_definition", "pointer", 
		"parameter_list", "parameter_declaration", "compound_statement", "statement", 
		"expression_statement", "selection_statement", "iteration_statement", 
		"jump_statement",
	];

	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		undefined, "'break'", "'char'", "'const'", "'continue'", "'do'", "'double'", 
		"'else'", "'float'", "'for'", "'if'", "'int'", "'long'", "'return'", "'short'", 
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		undefined, "Break", "Char", "Const", "Continue", "Do", "Double", "Else", 
		"Float", "For", "If", "Int", "Long", "Return", "Short", "Signed", "Sizeof", 
		"Struct", "Union", "Unsigned", "Void", "While", "LeftParen", "RightParen", 
		"LeftBracket", "RightBracket", "LeftBrace", "RightBrace", "Less", "LessEqual", 
		"Greater", "GreaterEqual", "LeftShift", "RightShift", "Plus", "PlusPlus", 
		"Minus", "MinusMinus", "Star", "Div", "Mod", "And", "AndAnd", "OrOr", 
		"Not", "Question", "Colon", "Semi", "Comma", "Assign", "StarAssign", "DivAssign", 
		"ModAssign", "PlusAssign", "MinusAssign", "Equal", "NotEqual", "Arrow", 
		"Dot", "Identifier", "Constant", "DigitSequence", "StringLiteral", "ComplexDefine", 
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(SourCParser._LITERAL_NAMES, SourCParser._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get grammarFileName(): string { return "SourCParser.g4"; }

	// @Override
	public get ruleNames(): string[] { return SourCParser.ruleNames; }

	// @Override
	public get serializedATN(): string { return SourCParser._serializedATN; }
	...
	public type_specifier(): Type_specifierContext {
		...
		try {
			...
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser.Char) | (1 << SourCParser.Double) | (1 << SourCParser.Float) | (1 << SourCParser.Int) | (1 << SourCParser.Long) | (1 << SourCParser.Short) | (1 << SourCParser.Signed) | (1 << SourCParser.Unsigned) | (1 << SourCParser.Void))) !== 0))) {
	...
	public translation_unit(): Translation_unitContext {
		...
		try {
			...
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser.Char) | (1 << SourCParser.Double) | (1 << SourCParser.Float) | (1 << SourCParser.Int) | (1 << SourCParser.Long) | (1 << SourCParser.Short) | (1 << SourCParser.Signed) | (1 << SourCParser.Unsigned) | (1 << SourCParser.Void))) !== 0)) {
				{
				{
				this.state = 72;
	...
	public declarator(): DeclaratorContext {
		...
		try {
			...
			case 3:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser.Char) | (1 << SourCParser.Double) | (1 << SourCParser.Float) | (1 << SourCParser.Int) | (1 << SourCParser.Long) | (1 << SourCParser.Short))) !== 0)) {
					{
					{
					this.state = 107;
					this.type_name();
			...
			case 4:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la === SourCParser.Sizeof || _la === SourCParser.LeftParen || ((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (SourCParser.Plus - 34)) | (1 << (SourCParser.PlusPlus - 34)) | (1 << (SourCParser.Minus - 34)) | (1 << (SourCParser.MinusMinus - 34)) | (1 << (SourCParser.Star - 34)) | (1 << (SourCParser.And - 34)) | (1 << (SourCParser.Not - 34)) | (1 << (SourCParser.Identifier - 34)) | (1 << (SourCParser.Constant - 34)) | (1 << (SourCParser.StringLiteral - 34)))) !== 0)) {
					{
					this.state = 116;
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_initializer_list);
					this.state = 141;
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_logical_or_expression);
					this.state = 168;
					if (!(this.precpred(this._ctx, 1))) {
						throw this.createFailedPredicateException("this.precpred(this._ctx, 1)");
					}
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_logical_and_expression);
					this.state = 179;
					if (!(this.precpred(this._ctx, 1))) {
						throw this.createFailedPredicateException("this.precpred(this._ctx, 1)");
					}
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_equality_expression);
						this.state = 190;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_relational_expression);
						this.state = 204;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_additive_expression);
						this.state = 224;
						if (!(this.precpred(this._ctx, 2))) {
							throw this.createFailedPredicateException("this.precpred(this._ctx, 2)");
						}
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_multiplicative_expression);
						this.state = 238;
						if (!(this.precpred(this._ctx, 3))) {
							throw this.createFailedPredicateException("this.precpred(this._ctx, 3)");
						}
	...
	public unary_operator(): Unary_operatorContext {
		...
		try {
			...
			this.state = 269;
			_la = this._input.LA(1);
			if (!(((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (SourCParser.Plus - 34)) | (1 << (SourCParser.Minus - 34)) | (1 << (SourCParser.Star - 34)) | (1 << (SourCParser.And - 34)) | (1 << (SourCParser.Not - 34)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public type_name(): Type_nameContext {
		...
		try {
			...
			this.state = 271;
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser.Char) | (1 << SourCParser.Double) | (1 << SourCParser.Float) | (1 << SourCParser.Int) | (1 << SourCParser.Long) | (1 << SourCParser.Short))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public sizeof_operands(): Sizeof_operandsContext {
		let _localctx: Sizeof_operandsContext = new Sizeof_operandsContext(this._ctx, this.state);
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_postfix_expression);
						this.state = 288;
					...
					case 2:
						...
						this._errHandler.sync(this);
						_la = this._input.LA(1);
						while (_la === SourCParser.Sizeof || _la === SourCParser.LeftParen || ((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (SourCParser.Plus - 34)) | (1 << (SourCParser.PlusPlus - 34)) | (1 << (SourCParser.Minus - 34)) | (1 << (SourCParser.MinusMinus - 34)) | (1 << (SourCParser.Star - 34)) | (1 << (SourCParser.And - 34)) | (1 << (SourCParser.Not - 34)) | (1 << (SourCParser.Identifier - 34)) | (1 << (SourCParser.Constant - 34)) | (1 << (SourCParser.StringLiteral - 34)))) !== 0)) {
							{
							{
							this.state = 295;
							this.expression(0);
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, SourCParser.RULE_parameter_list);
					this.state = 365;
					if (!(this.precpred(this._ctx, 1))) {
						throw this.createFailedPredicateException("this.precpred(this._ctx, 1)");
					}
	...
	public compound_statement(): Compound_statementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser.Break) | (1 << SourCParser.Char) | (1 << SourCParser.Continue) | (1 << SourCParser.Do) | (1 << SourCParser.Double) | (1 << SourCParser.Float) | (1 << SourCParser.For) | (1 << SourCParser.If) | (1 << SourCParser.Int) | (1 << SourCParser.Long) | (1 << SourCParser.Return) | (1 << SourCParser.Short) | (1 << SourCParser.Signed) | (1 << SourCParser.Sizeof) | (1 << SourCParser.Unsigned) | (1 << SourCParser.Void) | (1 << SourCParser.While) | (1 << SourCParser.LeftParen) | (1 << SourCParser.LeftBrace))) !== 0) || ((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (SourCParser.Plus - 34)) | (1 << (SourCParser.PlusPlus - 34)) | (1 << (SourCParser.Minus - 34)) | (1 << (SourCParser.MinusMinus - 34)) | (1 << (SourCParser.Star - 34)) | (1 << (SourCParser.And - 34)) | (1 << (SourCParser.Not - 34)) | (1 << (SourCParser.Semi - 34)) | (1 << (SourCParser.Identifier - 34)) | (1 << (SourCParser.Constant - 34)) | (1 << (SourCParser.StringLiteral - 34)))) !== 0)) {
				{
				{
				this.state = 384;
				this.statement();
	...
	public static get _ATN(): ATN {
		if (!SourCParser.__ATN) {
			SourCParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(SourCParser._serializedATN));
		}
...
export class Type_specifierContext extends ParserRuleContext {
	public Void(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Void, 0); }
	public Char(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Char, 0); }
	public Short(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Short, 0); }
	public Int(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Int, 0); }
	public Long(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Long, 0); }
	public Float(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Float, 0); }
	public Double(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Double, 0); }
	public Signed(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Signed, 0); }
	public Unsigned(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Unsigned, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_type_specifier; }
	// @Override
...
export class Translation_unitContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_translation_unit; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class External_declarationContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_external_declaration; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class DeclarationContext extends ParserRuleContext {
	...
	public Semi(): TerminalNode { return this.getToken(SourCParser.Semi, 0); }
	public type_specifier(): Type_specifierContext[];
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_declaration; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Init_declaratorContext extends ParserRuleContext {
	...
	public Assign(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Assign, 0); }
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_init_declarator; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class DeclaratorContext extends ParserRuleContext {
	public Identifier(): TerminalNode { return this.getToken(SourCParser.Identifier, 0); }
	...
	public Star(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Star, 0); }
	...
	public LeftBracket(): TerminalNode | undefined { return this.tryGetToken(SourCParser.LeftBracket, 0); }
	public RightBracket(): TerminalNode | undefined { return this.tryGetToken(SourCParser.RightBracket, 0); }
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_declarator; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class InitializerContext extends ParserRuleContext {
	...
	public LeftBrace(): TerminalNode | undefined { return this.tryGetToken(SourCParser.LeftBrace, 0); }
	public initializer_list(): Initializer_listContext | undefined {
		return this.tryGetRuleContext(0, Initializer_listContext);
	}
	public RightBrace(): TerminalNode | undefined { return this.tryGetToken(SourCParser.RightBrace, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_initializer; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Initializer_listContext extends ParserRuleContext {
	...
	public Comma(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Comma, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_initializer_list; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Assignment_expressionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_assignment_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Conditional_expressionContext extends ParserRuleContext {
	...
	public Question(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Question, 0); }
	public conditional_expression(): Conditional_expressionContext[];
	public conditional_expression(i: number): Conditional_expressionContext;
	public conditional_expression(i?: number): Conditional_expressionContext | Conditional_expressionContext[] {
		if (i === undefined) {
	...
	public Colon(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Colon, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_conditional_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Logical_or_expressionContext extends ParserRuleContext {
	...
	public OrOr(): TerminalNode | undefined { return this.tryGetToken(SourCParser.OrOr, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_logical_or_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Logical_and_expressionContext extends ParserRuleContext {
	...
	public AndAnd(): TerminalNode | undefined { return this.tryGetToken(SourCParser.AndAnd, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_logical_and_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Equality_expressionContext extends ParserRuleContext {
	...
	public Equal(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Equal, 0); }
	public NotEqual(): TerminalNode | undefined { return this.tryGetToken(SourCParser.NotEqual, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_equality_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Relational_expressionContext extends ParserRuleContext {
	...
	public Less(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Less, 0); }
	public Greater(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Greater, 0); }
	public LessEqual(): TerminalNode | undefined { return this.tryGetToken(SourCParser.LessEqual, 0); }
	public GreaterEqual(): TerminalNode | undefined { return this.tryGetToken(SourCParser.GreaterEqual, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_relational_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Additive_expressionContext extends ParserRuleContext {
	...
	public Plus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Plus, 0); }
	public Minus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Minus, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_additive_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Multiplicative_expressionContext extends ParserRuleContext {
	...
	public Star(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Star, 0); }
	public Div(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Div, 0); }
	public Mod(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Mod, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_multiplicative_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Cast_expressionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_cast_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Unary_expressionContext extends ParserRuleContext {
	...
	public PlusPlus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.PlusPlus, 0); }
	public unary_expression(): Unary_expressionContext | undefined {
		return this.tryGetRuleContext(0, Unary_expressionContext);
	}
	public MinusMinus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.MinusMinus, 0); }
	...
	public Sizeof(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Sizeof, 0); }
	public LeftParen(): TerminalNode | undefined { return this.tryGetToken(SourCParser.LeftParen, 0); }
	public sizeof_operands(): Sizeof_operandsContext | undefined {
		return this.tryGetRuleContext(0, Sizeof_operandsContext);
	}
	public RightParen(): TerminalNode | undefined { return this.tryGetToken(SourCParser.RightParen, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_unary_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Unary_operatorContext extends ParserRuleContext {
	public And(): TerminalNode | undefined { return this.tryGetToken(SourCParser.And, 0); }
	public Star(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Star, 0); }
	public Plus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Plus, 0); }
	public Minus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Minus, 0); }
	public Not(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Not, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_unary_operator; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Type_nameContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_type_name; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Sizeof_operandsContext extends ParserRuleContext {
	...
	public Identifier(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Identifier, 0); }
	public And(): TerminalNode | undefined { return this.tryGetToken(SourCParser.And, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_sizeof_operands; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Postfix_expressionContext extends ParserRuleContext {
	...
	public LeftParen(): TerminalNode | undefined { return this.tryGetToken(SourCParser.LeftParen, 0); }
	public RightParen(): TerminalNode | undefined { return this.tryGetToken(SourCParser.RightParen, 0); }
	public Dot(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Dot, 0); }
	public Identifier(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Identifier, 0); }
	public Arrow(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Arrow, 0); }
	public PlusPlus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.PlusPlus, 0); }
	public MinusMinus(): TerminalNode | undefined { return this.tryGetToken(SourCParser.MinusMinus, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_postfix_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Primary_expressionContext extends ParserRuleContext {
	public Identifier(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Identifier, 0); }
	public Constant(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Constant, 0); }
	public StringLiteral(): TerminalNode | undefined { return this.tryGetToken(SourCParser.StringLiteral, 0); }
	public LeftParen(): TerminalNode | undefined { return this.tryGetToken(SourCParser.LeftParen, 0); }
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_primary_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class ExpressionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Constant_expressionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_constant_expression; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Function_definitionContext extends ParserRuleContext {
	public Identifier(): TerminalNode { return this.getToken(SourCParser.Identifier, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser.LeftParen, 0); }
	public RightParen(): TerminalNode { return this.getToken(SourCParser.RightParen, 0); }
	public compound_statement(): Compound_statementContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_function_definition; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class PointerContext extends ParserRuleContext {
	public Star(): TerminalNode { return this.getToken(SourCParser.Star, 0); }
	public pointer(): PointerContext | undefined {
		return this.tryGetRuleContext(0, PointerContext);
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_pointer; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Parameter_listContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_parameter_list; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Parameter_declarationContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_parameter_declaration; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Compound_statementContext extends ParserRuleContext {
	public LeftBrace(): TerminalNode { return this.getToken(SourCParser.LeftBrace, 0); }
	public RightBrace(): TerminalNode { return this.getToken(SourCParser.RightBrace, 0); }
	public statement(): StatementContext[];
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_compound_statement; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class StatementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_statement; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Expression_statementContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_expression_statement; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Selection_statementContext extends ParserRuleContext {
	public If(): TerminalNode { return this.getToken(SourCParser.If, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser.LeftParen, 0); }
	public expression(): ExpressionContext {
	...
	public Else(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Else, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_selection_statement; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Iteration_statementContext extends ParserRuleContext {
	public While(): TerminalNode | undefined { return this.tryGetToken(SourCParser.While, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser.LeftParen, 0); }
	public expression(): ExpressionContext[];
	public expression(i: number): ExpressionContext;
	public expression(i?: number): ExpressionContext | ExpressionContext[] {
	...
	public Do(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Do, 0); }
	...
	public For(): TerminalNode | undefined { return this.tryGetToken(SourCParser.For, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_iteration_statement; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
...
export class Jump_statementContext extends ParserRuleContext {
	public Continue(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Continue, 0); }
	public Semi(): TerminalNode { return this.getToken(SourCParser.Semi, 0); }
	public Break(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Break, 0); }
	public Return(): TerminalNode | undefined { return this.tryGetToken(SourCParser.Return, 0); }
	public expression(): ExpressionContext | undefined {
		return this.tryGetRuleContext(0, ExpressionContext);
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser.RULE_jump_statement; }
	// @Override
	public enterRule(listener: SourCParserListener): void {
