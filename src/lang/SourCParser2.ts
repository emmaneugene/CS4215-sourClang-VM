...
export class SourCParser2 extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"type", "typeNameList", "program", "programStmt", "functionDefinition", 
		"paramLs", "param", "compoundStatement", "stmt", "expr", "primaryIdentifier", 
		"sizeOfOperands", "declaration", "typeDef", "exprLs", "seqExprLs", "assignment", 
		"addressableOperands",
	];
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(SourCParser2._LITERAL_NAMES, SourCParser2._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get grammarFileName(): string { return "SourCParser2.g4"; }

	// @Override
	public get ruleNames(): string[] { return SourCParser2.ruleNames; }

	// @Override
	public get serializedATN(): string { return SourCParser2._serializedATN; }
	...
	public type(): TypeContext {
		...
		try {
			...
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser2.Char) | (1 << SourCParser2.Double) | (1 << SourCParser2.Float) | (1 << SourCParser2.Int) | (1 << SourCParser2.Long) | (1 << SourCParser2.Short) | (1 << SourCParser2.Void))) !== 0))) {
	...
	public program(): ProgramContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser2.Char) | (1 << SourCParser2.Double) | (1 << SourCParser2.Float) | (1 << SourCParser2.Int) | (1 << SourCParser2.Long) | (1 << SourCParser2.Short) | (1 << SourCParser2.Struct) | (1 << SourCParser2.Unsigned) | (1 << SourCParser2.Void))) !== 0)) {
				{
				{
				this.state = 48;
				this.programStmt();
	...
	public functionDefinition(): FunctionDefinitionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser2.Char) | (1 << SourCParser2.Double) | (1 << SourCParser2.Float) | (1 << SourCParser2.Int) | (1 << SourCParser2.Long) | (1 << SourCParser2.Short) | (1 << SourCParser2.Struct) | (1 << SourCParser2.Unsigned) | (1 << SourCParser2.Void))) !== 0)) {
				{
				this.state = 63;
				this.paramLs();
				}
	...
	public compoundStatement(): CompoundStatementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser2.Break) | (1 << SourCParser2.Char) | (1 << SourCParser2.Continue) | (1 << SourCParser2.Double) | (1 << SourCParser2.Float) | (1 << SourCParser2.For) | (1 << SourCParser2.If) | (1 << SourCParser2.Int) | (1 << SourCParser2.Long) | (1 << SourCParser2.Return) | (1 << SourCParser2.Short) | (1 << SourCParser2.Sizeof) | (1 << SourCParser2.Struct) | (1 << SourCParser2.Unsigned) | (1 << SourCParser2.Void) | (1 << SourCParser2.While) | (1 << SourCParser2.LeftParen) | (1 << SourCParser2.LeftBrace))) !== 0) || ((((_la - 35)) & ~0x1F) === 0 && ((1 << (_la - 35)) & ((1 << (SourCParser2.PlusPlus - 35)) | (1 << (SourCParser2.Minus - 35)) | (1 << (SourCParser2.MinusMinus - 35)) | (1 << (SourCParser2.Star - 35)) | (1 << (SourCParser2.And - 35)) | (1 << (SourCParser2.Not - 35)) | (1 << (SourCParser2.Identifier - 35)) | (1 << (SourCParser2.Constant - 35)) | (1 << (SourCParser2.StringLiteral - 35)))) !== 0)) {
				{
				{
				this.state = 83;
				this.stmt();
	...
	public stmt(): StmtContext {
		...
		try {
			...
			case 7:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la === SourCParser2.Sizeof || _la === SourCParser2.LeftParen || ((((_la - 35)) & ~0x1F) === 0 && ((1 << (_la - 35)) & ((1 << (SourCParser2.PlusPlus - 35)) | (1 << (SourCParser2.Minus - 35)) | (1 << (SourCParser2.MinusMinus - 35)) | (1 << (SourCParser2.Star - 35)) | (1 << (SourCParser2.And - 35)) | (1 << (SourCParser2.Not - 35)) | (1 << (SourCParser2.Identifier - 35)) | (1 << (SourCParser2.Constant - 35)) | (1 << (SourCParser2.StringLiteral - 35)))) !== 0)) {
					{
					this.state = 122;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						_la = this._input.LA(1);
						if (!(((((_la - 38)) & ~0x1F) === 0 && ((1 << (_la - 38)) & ((1 << (SourCParser2.Star - 38)) | (1 << (SourCParser2.Div - 38)) | (1 << (SourCParser2.Mod - 38)))) !== 0))) {
					...
					case 3:
						...
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SourCParser2.Less) | (1 << SourCParser2.LessEqual) | (1 << SourCParser2.Greater) | (1 << SourCParser2.GreaterEqual))) !== 0))) {
	...
	public addressableOperands(): AddressableOperandsContext {
		let _localctx: AddressableOperandsContext = new AddressableOperandsContext(this._ctx, this.state);
	...
	public static readonly _serializedATN: string =
		...
		"\x07\x1A\x02\x02\xF5\xF7\x05\x14\v\x02\xF6\xF5\x03\x02\x02\x02\xF6\xF7" +
	...
	public static get _ATN(): ATN {
		if (!SourCParser2.__ATN) {
			SourCParser2.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(SourCParser2._serializedATN));
		}
...
export class TypeContext extends ParserRuleContext {
	public Void(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Void, 0); }
	public Char(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Char, 0); }
	public Short(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Short, 0); }
	public Int(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Int, 0); }
	public Long(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Long, 0); }
	public Float(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Float, 0); }
	public Double(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Double, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_type; }
	// @Override
...
export class TypeNameListContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_typeNameList; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class ProgramContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_program; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class ProgramStmtContext extends ParserRuleContext {
	...
	public Semi(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Semi, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_programStmt; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class FunctionDefinitionContext extends ParserRuleContext {
	...
	public Identifier(): TerminalNode { return this.getToken(SourCParser2.Identifier, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser2.LeftParen, 0); }
	public RightParen(): TerminalNode { return this.getToken(SourCParser2.RightParen, 0); }
	public compoundStatement(): CompoundStatementContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_functionDefinition; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class ParamLsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_paramLs; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class ParamContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_param; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class CompoundStatementContext extends ParserRuleContext {
	public LeftBrace(): TerminalNode { return this.getToken(SourCParser2.LeftBrace, 0); }
	public RightBrace(): TerminalNode { return this.getToken(SourCParser2.RightBrace, 0); }
	public stmt(): StmtContext[];
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_compoundStatement; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class StmtContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_stmt; }
...
export class ExprStmtContext extends StmtContext {
	...
	public Semi(): TerminalNode { return this.getToken(SourCParser2.Semi, 0); }
...
export class IfElseStmtContext extends StmtContext {
	public If(): TerminalNode { return this.getToken(SourCParser2.If, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser2.LeftParen, 0); }
	public expr(): ExprContext {
		return this.getRuleContext(0, ExprContext);
	}
	...
	public Else(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Else, 0); }
	constructor(ctx: StmtContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class WhileStmtContext extends StmtContext {
	public While(): TerminalNode { return this.getToken(SourCParser2.While, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser2.LeftParen, 0); }
	public expr(): ExprContext {
		return this.getRuleContext(0, ExprContext);
	}
...
export class ForStmtContext extends StmtContext {
	...
	public For(): TerminalNode { return this.getToken(SourCParser2.For, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser2.LeftParen, 0); }
...
export class ReturnExprContext extends StmtContext {
	public Return(): TerminalNode { return this.getToken(SourCParser2.Return, 0); }
	public Semi(): TerminalNode { return this.getToken(SourCParser2.Semi, 0); }
...
export class BreakStmtContext extends StmtContext {
	public Break(): TerminalNode { return this.getToken(SourCParser2.Break, 0); }
	public Semi(): TerminalNode { return this.getToken(SourCParser2.Semi, 0); }
	constructor(ctx: StmtContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
...
export class ContinueStmtContext extends StmtContext {
	public Continue(): TerminalNode { return this.getToken(SourCParser2.Continue, 0); }
	public Semi(): TerminalNode { return this.getToken(SourCParser2.Semi, 0); }
	constructor(ctx: StmtContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
...
export class ExprContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_expr; }
...
export class SuffixIncrContext extends ExprContext {
	...
	public PlusPlus(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.PlusPlus, 0); }
	public MinusMinus(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.MinusMinus, 0); }
...
export class UnopContext extends ExprContext {
	...
	public Not(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Not, 0); }
	public Minus(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Minus, 0); }
	constructor(ctx: ExprContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class DereferenceContext extends ExprContext {
	public Star(): TerminalNode { return this.getToken(SourCParser2.Star, 0); }
	public expr(): ExprContext {
		return this.getRuleContext(0, ExprContext);
	}
	constructor(ctx: ExprContext) {
...
export class AddressOfContext extends ExprContext {
	public And(): TerminalNode { return this.getToken(SourCParser2.And, 0); }
	public expr(): ExprContext {
		return this.getRuleContext(0, ExprContext);
	}
	constructor(ctx: ExprContext) {
...
export class SizeofExprContext extends ExprContext {
	public Sizeof(): TerminalNode { return this.getToken(SourCParser2.Sizeof, 0); }
	public LeftParen(): TerminalNode { return this.getToken(SourCParser2.LeftParen, 0); }
	public sizeOfOperands(): SizeOfOperandsContext {
...
export class MultContext extends ExprContext {
	...
	public Star(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Star, 0); }
	public Div(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Div, 0); }
	public Mod(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Mod, 0); }
	constructor(ctx: ExprContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class AddContext extends ExprContext {
	...
	public Plus(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Plus, 0); }
	public Minus(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Minus, 0); }
	constructor(ctx: ExprContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
...
export class RelOprContext extends ExprContext {
	...
	public Greater(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Greater, 0); }
	public GreaterEqual(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.GreaterEqual, 0); }
	public Less(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Less, 0); }
	public LessEqual(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.LessEqual, 0); }
	constructor(ctx: ExprContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class EqualityContext extends ExprContext {
	...
	public Equal(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Equal, 0); }
	public NotEqual(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.NotEqual, 0); }
	constructor(ctx: ExprContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class AndContext extends ExprContext {
	...
	public AndAnd(): TerminalNode { return this.getToken(SourCParser2.AndAnd, 0); }
	constructor(ctx: ExprContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class OrContext extends ExprContext {
	...
	public OrOr(): TerminalNode { return this.getToken(SourCParser2.OrOr, 0); }
	constructor(ctx: ExprContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class TernaryContext extends ExprContext {
	...
	public Question(): TerminalNode { return this.getToken(SourCParser2.Question, 0); }
	public Colon(): TerminalNode { return this.getToken(SourCParser2.Colon, 0); }
	public expr(): ExprContext[];
	public expr(i: number): ExprContext;
	public expr(i?: number): ExprContext | ExprContext[] {
		if (i === undefined) {
...
export class PrimaryIdentifierContext extends ParserRuleContext {
	...
	public Constant(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Constant, 0); }
	public StringLiteral(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.StringLiteral, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_primaryIdentifier; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class SizeOfOperandsContext extends ParserRuleContext {
	...
	public Identifier(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Identifier, 0); }
	public And(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.And, 0); }
	public Struct(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Struct, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_sizeOfOperands; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class DeclarationContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_declaration; }
...
export class VariableDeclContext extends DeclarationContext {
	...
	public Identifier(): TerminalNode { return this.getToken(SourCParser2.Identifier, 0); }
	public Assign(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Assign, 0); }
	public expr(): ExprContext | undefined {
		return this.tryGetRuleContext(0, ExprContext);
	}
...
export class ArrayDeclContext extends DeclarationContext {
	...
	public Identifier(): TerminalNode { return this.getToken(SourCParser2.Identifier, 0); }
	public LeftBracket(): TerminalNode { return this.getToken(SourCParser2.LeftBracket, 0); }
	public RightBracket(): TerminalNode { return this.getToken(SourCParser2.RightBracket, 0); }
	public expr(): ExprContext | undefined {
		return this.tryGetRuleContext(0, ExprContext);
	}
	public Assign(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Assign, 0); }
...
export class StructDeclContext extends DeclarationContext {
	public Struct(): TerminalNode { return this.getToken(SourCParser2.Struct, 0); }
	public Identifier(): TerminalNode { return this.getToken(SourCParser2.Identifier, 0); }
	public LeftBrace(): TerminalNode { return this.getToken(SourCParser2.LeftBrace, 0); }
	public RightBrace(): TerminalNode { return this.getToken(SourCParser2.RightBrace, 0); }
	public declaration(): DeclarationContext[];
...
export class TypeDefContext extends ParserRuleContext {
	...
	public Unsigned(): TerminalNode | undefined { return this.tryGetToken(SourCParser2.Unsigned, 0); }
	public Star(): TerminalNode[];
	public Star(i: number): TerminalNode;
	public Star(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_typeDef; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class ExprLsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_exprLs; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class SeqExprLsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_seqExprLs; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class AssignmentContext extends ParserRuleContext {
	...
	public Assign(): TerminalNode { return this.getToken(SourCParser2.Assign, 0); }
	public expr(): ExprContext | undefined {
		return this.tryGetRuleContext(0, ExprContext);
	}
	public exprLs(): ExprLsContext | undefined {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_assignment; }
	// @Override
	public enterRule(listener: SourCParser2Listener): void {
...
export class AddressableOperandsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return SourCParser2.RULE_addressableOperands; }
...
export class StructAccessContext extends AddressableOperandsContext {
	...
	public Dot(): TerminalNode { return this.getToken(SourCParser2.Dot, 0); }
	constructor(ctx: AddressableOperandsContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class StructAccessThruPointerContext extends AddressableOperandsContext {
	...
	public Arrow(): TerminalNode { return this.getToken(SourCParser2.Arrow, 0); }
	constructor(ctx: AddressableOperandsContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
